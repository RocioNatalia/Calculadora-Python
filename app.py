...
Button(root, text="⇽", command=lambda: undo()).grid(row=1, column=5, sticky=W + E)
Button(root, text="*", command=lambda: get_operations("*")).grid(row=2, column=4, sticky=W + E)
...
Button(root, text="EXP", command=lambda: get_operations("**")).grid(row=2, column=5, sticky=W + E)
Button(root, text="^2", command=lambda: get_operations("**2")).grid(row=3, column=5, sticky=W + E)
Button(root, text="√", command=lambda: get_operations("**0.5")).grid(row=4, column=5, sticky=W + E)
